...
var _user$project$DrumMachine$renderFooter = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[]));
var _user$project$DrumMachine$renderBeats = F2(
	function (music, currentStep) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$id('music-grid')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
...
var _user$project$DrumMachine$renderHeading = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$id('heading-area')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$id('heading')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('World Wide Beats')
				])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('A Web Audio Beat-Machine Written In Elm')
				]))
		]));
var _user$project$DrumMachine$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
...
var _user$project$DrumMachine$Model = F6(
	function (a, b, c, d, e, f) {
		return {musicGrid: a, tempo: b, currentStep: c, isPlaying: d, playStopButtonHighlighted: e, clearButtonHighlighted: f};
	});
...
var _user$project$DrumMachine$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('main-app')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
